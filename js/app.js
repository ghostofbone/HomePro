(() => {
    ...
    function buildBlogItem(item) {
        ...
        item.image ? blogItemTemplate += `<div class="item-blog__image-ibg">\n\t\t\t<a href="${item.url}" class=" item-blog__link">\n\t\t\t\t<img src="${item.image}" alt="Image">\n\t\t\t</a>\n\t\t</div>` : null;
    ...
    function viewMore() {
        ...
        const currrentItems = document.querySelectorAll(".item-blog").length;
        const viewMore = document.querySelector(".blog__view-more");
        currrentItems < dataItemsLength ? viewMore.hidden = false : viewMore.hidden = true;
    }
